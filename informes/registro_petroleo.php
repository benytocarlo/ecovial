            ...
            <main id="main-container">
                ...
                <div class="content bg-image overflow-hidden" style="background-image: url('assets/img/photos/fresadora_rutas_2a-1.png');">
                    <div class="push-50-t push-15">
                        <h1 class="h2 text-white animated zoomIn sombra">Registro Constructura Rutas</h1>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="block block-themed">
                                <div class="block-header bg-primary">
                                    <h3 class="block-title">Registro Report Petróleo Constructora Rutas</h3>
                                </div>
                                    ...
                                    <form action="" class="form-horizontal push-5-t" id="formulario" name="formulario" method="POST">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group">
                                                <label class="col-xs-12" for="register1-username">Operador / Chofer</label>
                                                <div class="col-xs-12">
                                            ...
                                            <div class="form-group">
                                                <label class="col-xs-12" for="register1-username">Patente</label>
												<div class="col-xs-12">
                                            ...
                                            <div class="form-group">
                                                <label class="col-xs-12" for="register1-username">Litros</label>
                                                <div class="col-xs-12">
                                                    <input class="form-control" type="number" id="litros" name="litros" placeholder="">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-xs-12" for="register1-username">Hora Término: (Horometro - Odometro)</label>
                                                <div class="col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
												<input type="hidden" name="action" id="action" value="petroleo">
                                                <button class="btn btn-sm btn-success" type="submit"><i class="fa fa-plus push-5-r"></i> Insertar Registro</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
		               ...
		               $( ".enviarform" ).click(function() {
		                ...
		                $("#formulario").validate({
		                  ...
		                  messages: {
		                    ...
		                    patente     : { required:'Campo Obligatorio' },
		                    litros   : { required:'Campo Obligatorio' },
