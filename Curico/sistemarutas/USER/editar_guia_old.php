...
<div class="page-content">	
			<!-- CONTENT -->
			<div id="form_pesaje"><span class="Estilo1">Editar  Guia</span>
			  <fieldset>
				<legend></legend>
              </fieldset>
		<form action="guia_mostrar.php" method="post" name="form" id="form" target="_blank" >
        <center>
...
<tr>
            ...
            <td width="219"><label>
             <select name="n_guia" id="n_guia" >
                    ...
                    <?$sql ="SELECT * FROM pesaje order by id desc";
