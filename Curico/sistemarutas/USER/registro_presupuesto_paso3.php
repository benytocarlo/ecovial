...
$sql="Select * from detalle_presupuesto where id_presupuesto=".$num_presupuesto;
...
<div class="page-content">	
			<!-- CONTENT -->
            	<form action="registro_presupuesto_paso4.php" method="post" name="form" id="form" >
...
<tr>
            ...
            <td width="219"><strong>Descuento</strong>
              ...
              <input type="button" name="nuevo_cliente" class="formbutton2" value="Aplicar Descuento"  onclick="xajax_aplicar_descuento2(xajax.getFormValues('form'))" id="nuevo_cliente"/></td>
              ...
              <input name="total_descuento" type="text" id="total_descuento" "/></td>
                      ...
                      <tr>
                        <td height="63" id="mezcla_name"><strong>19 % IVA</strong>
                          <input name="iva" type="text" id="iva" value="<? echo $iva; ?>" readonly="readonly"/></td>
                        ...
                        <td ><input type="submit" name="nuevo_obra2" class="formbutton" value="Finalizar Presupuesto"  id="nuevo_obra2"/></td>
            </tr>
                    </table>	
        <p>&nbsp;</p>
        <p>&nbsp;</p>
