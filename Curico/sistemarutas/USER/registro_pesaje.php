            ...
            <td><strong>Valor Unitario Producto<br />
                      ...
                      <tr>
                        ...
                        <td><input type="hidden" name="id_mezcla" id="id_mezcla" />
                          ...
                          <input type="button" name="calcular" class="formbutton2"  value="Calcular M3" id="calcular" onclick="xajax_calcularm3(document.form.orden_compra.value,document.form.mezclita.value,document.form.peso.value,document.form.tara.value,document.form.orden_compra.value);" />
                          </strong></td>
            </tr>
                      <tr>
                        <td height="69">&nbsp;</td>
