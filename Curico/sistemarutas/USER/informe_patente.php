...
<div class="content">
		...
		<div class="page-content">	
			<p>
			  <!-- CONTENT -->
		      <span class="Estilo1">Informe por<strong> Patente</strong></span></p>
<table width="696" border="0">
              <tr>
                <td width="21" height="258"><p class="clear">&nbsp;</p>
                </td>
                <td width="665"><form id="form1" method="post" action="" target="_blank">
                  <table width="611" height="182" border="0">
                    <tr>
                      <td width="136" height="43"><strong>N&deg; Patente</strong></td>
                    <td width="465"><label>
                    ...
                    <tr>
                      ...
                      <input type="button" value="Ver Calendario" onclick="displayCalendar(document.forms[0].fecha_inicio,'dd/mm/yyyy',this)" /></td>
                    </tr>
                    <tr>
                      <td height="43"><strong>Fecha Termino</strong></td>
                      <td><input type="text" readonly="readonly" name="fecha_final" />
                        <input type="button" value="Ver Calendario" onclick="displayCalendar(document.forms[0].fecha_final,'dd/mm/yyyy',this)" /></td>
                    </tr>
                    <tr>
                      <td height="43">&nbsp;</td>
