...
<div class="wrapper">
  ...
  <div class="page-content">	
		...
		<form action="guia2.php" method="post" name="form" id="form" >
        <center>
...
<tr>
              ...
              <td><strong>N° de Guía</strong>
                <input name="n_guia" type="text" id="n_guia" value="<? echo $n_guia; ?>" readonly="readonly"/></td>
</tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td><strong>Tipo Emulsión<br />
                              <select name="tipo_mezcla" id="tipo_mezcla">
                                <option value="">Elija una Opci&oacute;n</option>
                                <?$sql ="SELECT * FROM mezclas where tipo='Emulsion'";
       ...
       <span> <strong>Listado de Productos Agregados a la Orden de Compra</strong></span> </p>
        ...
        <table id="listado_productos">
          <tr>
            <th width="145">Nombre Producto</th>
            <th width="172">N° Litros</th>
            <th width="140">Valor Unitario</th>
            <th width="215">Total</th>
          </tr>
        </table>
