...
<body>
<?   $id = $_GET['id']; 
 		  $SQL ="SELECT * from centrocostos where id=$id";
...
<form action="actualizar.php?id=<?echo $id; ?>&amp;oculto=centro" method="post">
<table width="558" height="129">
                      <tr>
                        <td width="198"><strong>ID</strong></td>
                        <td width="348"><input name="id" type="text" id="id" value="<? echo $id; ?>" /></td>
                      </tr>
                      <tr>
