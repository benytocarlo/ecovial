...
<div class="sidebar column-left">
  <ul>
    <li>
      <h4>Acciones</h4>
      <ul>
        <li><a href="buscar_presupuesto.php" > Buscar Presupuesto</a><a href="buscar_orden_compra.php" ></a></li>
        </ul>
    </li>
  </ul>
  <ul>
...
<div class="page-content">	
			<!-- CONTENT -->
			<div id="form_pesaje"><span class="Estilo1">Busqueda de Presupuesto</span>
			  <fieldset>
				<legend></legend>
              </fieldset>
		<form action="presupuesto_mostrar.php" method="post" name="form" id="form" target="_blank" >
        <center>
<table width="657" height="87" align="center">
<tr>
                        <td width="208" height="81"><strong>Numero de Presupuesto</strong></td>
            <td width="219"><label>
