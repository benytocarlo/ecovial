				   ...
				   $suma=0;
				    $sql_list ="select * from detalle_orden_compra where id_orden_compra=".$num_orden." ";
					  ...
					  $centrocc=$row[8];
                        ...
                        <td><div align="center"><? echo number_format($row[5], 0, '', '.'); ?></div></td>
                        <td><div align="center"><? echo number_format($row[6], 0, '', '.'); ?></div></td>
                  </tr>
                  <? } ?>
                </table></td>
            </tr>
            ...
            <tr>
              ...
              <td width="221"><table width="210"  align="right">
                <tr>
                  ...
                  <td width="83"><? echo number_format($total_neto, 0, '', '.'); ?></td>
                </tr>
                <tr>
                  <td nowrap="nowrap">% Dcto.:</td>
                  <td><? echo number_format($descuento, 0, '', '.');  ?></td>
                </tr>
                <tr>
                  <td nowrap="nowrap">Neto:</td>
                  <td><? echo number_format($total_descuento, 0, '', '.'); ?></td>
                </tr>
                ...
                <? if($extra_iva=="Ord Compra CON IVA")
						...
						?>
                         <tr>
                          ...
                          <td><? echo number_format($iva, 0, '', '.'); ?></td>
                        </tr>
                ...
                <tr> 
                  ...
                  <td><? echo number_format($total_bruto, 0, '', '.'); ?></td>
                </tr>
                <tr>
