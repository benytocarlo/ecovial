...
Rancagua</p></td>
 ...
 <? $sql2="select * from  pesaje pesj , mezclas mle where pesj.fecha_hora  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."'  and pesj.tipo_mezcla=mle.id and pesj.tipo_mezcla='".$mezclita."'";
// echo $sql2;
		$sumacantidad=0;
		  $sumatotal=0;
