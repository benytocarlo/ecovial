      ...
      <tr>
        ...
        <table width="841" border="1">
          <tr>
           ...
           <? $sql2="select * from transportista tra,  pesaje ing_or   ,camiones cam where ing_or.fecha_hora  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."' and ing_or.obra=".$obra." and ing_or.transportista=tra.id and ing_or.patente=cam.id and ing_or.nula!='si' order by tra.id asc";
		 $sumacantidad=0;
		  $sumatotal=0;
        ...
        <table width="841" border="1">
          <tr>
           ...
           <? $sql2="select * from transportista tra,  pesaje ing_or   ,camiones cam where ing_or.fecha_hora  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."' and ing_or.obra=".$obra." and ing_or.transportista=tra.id and ing_or.patente=cam.id and ing_or.nula!='si' and ing_or.tipo_guia='emulsion' order by tra.id asc";
		 $sumacantidad=0;
		  $sumatotal=0;
		  $result2 = mysql_query($sql2); 
						while($row = mysql_fetch_row($result2))
