...
Rancagua</p></td>
 ...
 <? $sql2="select * from  pesaje pesj ,cliente cli where pesj.fecha_hora  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."' and pesj.cliente=cli.id and pesj.tipo_guia!='emulsion' and pesj.nula!='si'";
		$sumacantidad=0;
		  $sumatotal=0;
 ...
 <? $sql2last="select * from  pesaje pesj ,cliente cli where pesj.fecha_hora  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."' and pesj.cliente=cli.id and pesj.tipo_guia='emulsion' and pesj.nula!='si'";
		$sumacantidad=0;
		  $sumatotal=0;
