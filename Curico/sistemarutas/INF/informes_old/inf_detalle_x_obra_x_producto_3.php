...
Rancagua</div>
      ...
      <tr>
        <td height="86"><table width="841" border="1">
		  ...
		  <?  $sqlval="select * from transportista tra,  pesaje ing_or  , mezclas mle ,camiones cam where ing_or.fecha_hora  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."' and ing_or.obra=".$obra." and ing_or.transportista=tra.id and mle.id=ing_or.tipo_mezcla and ing_or.patente=cam.id";
				...
				while($row = mysql_fetch_row($result2))
						...
						if($tipoemulsion=="emulsion")
							{
							$sqltipo="select * from detalle_pesaje where guia='".$orden."' and producto='".$nombre_product."'";
							//	$sqltipo="select * from detalle_pesaje dp ,mezclas mle where dp.guia='".$orden."' and mle.nombre='".$nombre_product."'";
								//$sqltipo="select * from detalle_pesaje dp ,mezclas mle where dp.guia='".$orden."' and mle.nombre=".$nombre_product."";
								//echo $sqltipo;
