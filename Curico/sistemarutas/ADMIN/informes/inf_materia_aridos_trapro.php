          ...
          <tr>
            <td width="542" height="138"><table width="525" border="0">
              <tr>
                ...
                <td width="432"><div align="center"><span class="Estilo5">Informe Ingreso de Aridos por Proveedor</span></div></td>
              </tr>
      ...
      <tr>
        <td height="74"><table width="841" border="0">
		  ...
		  <tr>
            ...
            <td width="695"><?php echo $nombre_proveedor; ?></td>
          </tr>
          <tr>
            <td>Desde:</td>
...
<?		 
		 $sql2="select * from ingreso_materias ing_mat, proveedor pro, transportista tra, materias mat where ing_mat.fecha_guia  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."' and ing_mat.materia=".$materia." and ing_mat.proveedor=pro.id and ing_mat.proveedor=".$proveedor." and ing_mat.nula!='si' and ing_mat.transportista=tra.id and ing_mat.transportista=".$transportista." and ing_mat.proveedor=pro.id and ing_mat.materia=mat.id order by ing_mat.fecha_guia ASC";
		//echo $sql2;
		$sumacantidad=0;
		  $sumatotal=0;
