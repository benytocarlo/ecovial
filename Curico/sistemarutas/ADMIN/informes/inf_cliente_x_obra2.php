          ...
          <tr>
            <td width="542" height="138"><table width="525" border="0">
              <tr>
                ...
                <td width="432"><div align="center"><span class="Estilo5">Informe de Cliente por Obra</span></div></td>
              </tr>
      ...
      <tr>
        ...
        <table width="841" border="1">
          <tr>
            ...
            <td width="150">Producto Comprado</td>
			</tr>
		 <? $sql2="select * from  pesaje pe, obra ob, detalle_pesaje dp where fecha_hora  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."'  and cliente='".$cliente."' and obra='".$obra."' and pe.id=dp.guia and pe.nula!='si' and pe.obra=ob.id order by pe.id asc"  ;
			// echo $sql2;
		  $sumacantidad=0;
		  $sumatotal=0;
