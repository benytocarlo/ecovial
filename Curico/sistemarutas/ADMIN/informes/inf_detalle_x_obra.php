      ...
      <tr>
        ...
        <table width="841" border="1">
          <tr>
           ...
           <? $sql2="select * from transportista tra,  pesaje ing_or   , detalle_pesaje dp, camiones cam where ing_or.fecha_hora  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."' and ing_or.obra=".$obra." and ing_or.id=dp.guia and ing_or.transportista=tra.id and ing_or.patente=cam.id and ing_or.nula!='si' order by ing_or.fecha_hora and ing_or.id";	
			//echo $sql2;
			$sumacantidad=0;
		  $sumatotal=0;
		  $entro1="no";
