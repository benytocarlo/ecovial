...
Planta Curicó</strong></p>
      ...
      <tr>
	    ...
	    <td width="50">Patente</td>
		 ...
		 <? $sql2="select * from  pesaje pe, obra ob, detalle_pesaje dp, camiones cam where fecha_hora  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."'  and cliente='".$cliente."' and pe.id=dp.guia and pe.nula!='si' and pe.obra=ob.id and pe.patente=cam.id order by pe.id asc"  ;
			// echo $sql2;
		  $sumacantidad=0;
		  $sumatotal=0;
