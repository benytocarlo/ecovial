      ...
      <tr>
        ...
        <table width="841" border="1">
          <tr>
           ...
           <? $sql2="select * from pesaje pe,camiones cam, cliente cli, obra ob where pe.fecha_hora  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."' and cam.id=pe.patente and cli.id=pe.cliente and ob.id=pe.obra and pe.nula!='si' and pe.tipo_guia='servicio'";
			//echo $sql2;
		   		 $sumacantidad=0;
		  $sumatotal=0;
		  $result2 = mysql_query($sql2); 
						while($row = mysql_fetch_row($result2))
						{
							...
							$sql2list="select * from  detalle_pesaje dp, mezclas me where dp.guia='".$guia."' and dp.producto = me.id";
							//echo $sql2list;
