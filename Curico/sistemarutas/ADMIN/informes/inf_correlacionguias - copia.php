...
<?		 
		  $sql2last="select * from pesaje dp, cliente li, obra ob where dp.fecha_hora  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."' and dp.cliente=li.id and dp.obra=ob.id and dp.nula!='si' order by dp.id";
										//echo $sql2last;
		  $sumacantidad=0;
		  $sumatotal=0;
		  $totaltraslado=0;
