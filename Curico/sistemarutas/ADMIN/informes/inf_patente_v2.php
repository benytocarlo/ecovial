    ...
    <td width="851" height="333"><table width="851" height="331" border="0">
      ...
      <tr>
        <td height="74"><table width="841" border="0">
          <tr>
            ...
            <td width="695"><?php echo $nombre_patente; ?></td>
          </tr>
          <tr>
            <td>Desde:</td>
      ...
      <tr>
        ...
        <table width="841" border="1">
		 ...
		 <? $sql2="select * from  pesaje pe, obra ob, detalle_pesaje dp, camiones ca where fecha_hora  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."'  and pe.patente='".$patente."' and pe.id=dp.guia and pe.nula!='si' and pe.obra=ob.id order by pe.id asc"  ;
			 echo $sql2;
		  $sumacantidad=0;
		  $sumatotal=0;
...
<? $sql2="select * from  pesaje where fecha_hora  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."'  and patente='".$patente."' and tipo_guia='emulsion' and nula!='si'" ;
		  $sumacantidad=0;
		  $sumatotal=0;
		  $result2 = mysql_query($sql2); 
...
<? $sql2="select * from  pesaje where fecha_hora  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."'  and patente='".$patente."' and tipo_guia='combustible' and nula!='si'" ;
		  $sumacantidad=0;
		  $sumatotal=0;
		  $result2 = mysql_query($sql2); 
       ...
       <tr>
        ...
        <table width="841" border="1">
          <tr>
           ...
           <? $sql2="select * from pesaje pe,camiones cam where pe.fecha_hora  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."' and  cam.id=pe.patente and patente='".$patente."' and pe.nula!='si' and pe.tipo_guia='servicio'";
		//	echo $sql2;
		   		 $sumacantidad=0;
		  $sumatotal=0;
		  $result2 = mysql_query($sql2); 
