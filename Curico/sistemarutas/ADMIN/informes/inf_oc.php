      ...
      <tr>
        <td width="841" height="98"><table width="841" border="0">
          <tr>
            ...
            <td width="283" align="center"><div align="center">
              <strong>Constructora RUTAS SpA<br />
RUT: 76.495.749-0<br />
Planta Curicó</strong></td>
          </tr>
        </table>          </td>
        </tr>
      <tr>
      ...
      <tr>
        ...
        <table width="961" border="1">
          <tr>
            <td width="70" height="23">N° OC</td>
            <td width="120"><p>Fecha</p></td>
            <td width="290">Proveedor</td>
            <td width="250">1ra. Descripción</td>
            <td width="100">Monto Neto Total</td>
