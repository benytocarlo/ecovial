          ...
          <tr>
            <td width="542" height="138"><table width="525" border="0">
              <tr>
                ...
                <td width="432"><div align="center"><span class="Estilo5">Informe Ventas Terceros</span></div></td>
              </tr>
...
Planta Curicó</strong></p>
      ...
      <tr>
        ...
        <table width="841" border="1">
          <tr>
            <td width="87" height="23">Cliente</td>
		 ...
		 <? $sql2="select * from  pesaje pe, obra ob, detalle_pesaje dp, cliente cli where fecha_hora  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."' and pe.cliente!='8' and pe.cliente!='24' and pe.id=dp.guia and pe.nula!='si' and pe.obra=ob.id and pe.cliente=cli.id order by pe.id asc"  ;
			 //echo $sql2;
		  $sumacantidad=0;
		  $sumatotal=0;
