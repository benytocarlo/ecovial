...
<?		 
		 $sql2="select * from ingreso_materias ing_mat, proveedor pro, materias mat where ing_mat.fecha_guia  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."' and ing_mat.materia=".$materia." and ing_mat.proveedor=pro.id and ing_mat.proveedor=".$proveedor." and ing_mat.nula!='si' and  ing_mat.proveedor=pro.id and ing_mat.materia=mat.id order by ing_mat.fecha_guia ASC";
		$sumacantidad=0;
		  $sumatotal=0;
