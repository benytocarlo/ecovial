      ...
      <tr>
        ...
        <table width="841" border="1">
          <tr>
            ...
            <td width="76">Obra</td>
            <td width="76">Patente</td>
            </tr>
<?		 
		  $sql2last="select * from pesaje dp, cliente li, obra ob, camiones ca where dp.fecha_hora  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."' and dp.cliente=li.id and dp.obra=ob.id and dp.patente=ca.id and dp.nula!='si' order by dp.id";
										//echo $sql2last;
		  $sumacantidad=0;
		  $sumatotal=0;
		  $totaltraslado=0;
					...
					//			echo $sql2;
							...
							//	echo $sql2;
								...
								{ 
										...
										$totalfinal5=$totalfinal5+$total;
			 					}     
							}
							
						}
						$totalfinality=$totalfinal2+$totalfinal3+$totalfinal4+$totalfinal5;
          ?>
        ...
        <table width="840" border="1">
            <tr>
              <td width="421">&nbsp;</td>
                ...
                <td width="63"><? echo number_format($totalfinality, 0, '', '.'); ?></td>
                <td width="89">&nbsp;</td>
            </tr>
          </table>
          <br />
          <table width="840" border="1">
            ...
            <tr>
              ...
              <td><? echo $totalmezclas; ?></td>
                ...
                <tr>
              <td>Total Guias Servicio de Planta</td>
              <td><? echo $totalservicio; ?></td>
              </tr>
            <tr>
