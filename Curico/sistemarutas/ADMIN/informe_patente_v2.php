		...
		<div class="page-content">	
	        ...
	        <table width="696" border="0">
              <tr>
                ...
                <td width="665"><form id="form1" method="post" action="informes/inf_patente_v2.php" target="_blank" >
                  <table width="611" height="182" border="0">
                    <tr>
                      <td width="136" height="43"><strong>Patente</strong></td>
<td width="465"><label></label>
  <div id="select_patente">
    <select name="patente2" id="patente2">
