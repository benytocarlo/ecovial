...
<div class="content">
		...
		<div class="page-content">	
			<p>
			  <!-- CONTENT -->
		      <span class="Estilo1">Informe Carga de Combustible </strong></span></p>
            <table width="696" border="0">
              <tr>
                <td width="21" height="258"><p class="clear">&nbsp;</p>
                </td>
                <td width="665"><form id="form1" method="post" action="informes/inf_petroleo_cliente.php" target="_blank">
    ...
    <select name="cliente2" id="cliente2">
      ...
      <?}?>
				  ...
				  <table width="611" height="137" border="0">
                    <tr>
                      <td width="136" height="43"><strong>Fecha Inicio</strong></td>
                      <td width="465"><input type="text" readonly="readonly" name="fecha_inicio" />
