...
<div class="content">
		...
		<div class="page-content">	
			<p>
			  <!-- CONTENT -->
		      <span class="Estilo1">Informe Materias <strong>Primas por Proveedor</strong></span></p>
	        <table width="696" border="0">
              <tr>
                <td width="21" height="258"><p class="clear">&nbsp;</p>
                </td>
                <td width="665"><form id="form1" method="post" action="informes/inf_materia_aridos_trapro.php" target="_blank" >
                  <table width="611" height="182" border="0">
                    <tr>
					  ...
					  <tr>
                      <td width="136" height="43"><strong>Transportista</strong></td>
						<td width="465"><label></label>
						  <div id="select_cliente">
							<select name="transportista" id="transportista">
							  ...
							  <?}?>
					                    ...
					                    <tr>
                      <td width="136" height="43"><strong>Proveedor</strong></td>
						<td width="465"><label></label>
						  <div id="select_cliente">
