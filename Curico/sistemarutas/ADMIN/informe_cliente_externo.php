...
<div class="content">
		...
		<div class="page-content">	
			<p>
			  <!-- CONTENT -->
		      <span class="Estilo1">Informe Venta a Terceros<strong></strong></span></p>
	        <table width="696" border="0">
              <tr>
                <td width="21" height="258"><p class="clear">&nbsp;</p>
                </td>
                <td width="665"><form id="form1" method="post" action="informes/inf_cliente_externo.php" target="_blank" >
                  <table width="611" height="137" border="0">
                    <tr>
                      <td width="136" height="43"><strong>Fecha Inicio</strong></td>
                      <td width="465"><input name="fecha_inicio" type="text" class="Estilo2" readonly="readonly" />
