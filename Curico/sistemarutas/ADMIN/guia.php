...
include("conexion.php");
	...
	$m3=$_POST["m3"];
	$mezclita=$_POST["id_mezcla"];
	$valor_mezcla=$_POST["valor_mezcla"];
	$partidacontrol=$_POST["partidacontrol"];
	$sql="insert into pesaje (temperatura,num_pesaje,patente,fecha_hora,transportista,chofer,peso_bruto,tara,obra,n_orden,cliente,partidacontrol) values 
							('$temperatura','$num_pesaje','$patente','$fecha','$transportista','$chofer','$peso','$tara','$obra','$odcompra','$cliente','$partidacontrol')";
...
<form name="guia" id="guia">
  <table width="1025" height="200" border="0">
    <tr>
      <td height="243">&nbsp;</td>
    </tr>
  </table>
...
?>
    ...
    <tr>
      ...
      <td colspan="2" valign="top" align="right"><? echo $odcompra." - ".$partidacontrol; ?></td>
    </tr>
    <tr>
