...
<div class="page-content">	
			<!-- CONTENT -->
			<span class="Estilo1">Listado de Transportistas</span>
            <fieldset>
				<legend></legend>
				...
				?>
                      ...
                      <tr>
                        ...
                        <td><table width="94" border="0" align="center">
                          <tr>
                            <td width="42" ><a href="editar_transportista.php?id=<? echo $row[0]; ?>"><img src="images/001_45.png" alt="" width="24" height="24" border="0" /></a></td>
                            <td width="42"><a href="eliminar.php?id=<? echo $row[0]; ?>&amp;oculto=transportista"><img src="images/001_05.png" alt="" width="24" height="24" border="0" /></a></td>
                          </tr>
                        </table></td>
                      </tr>
					  <? }  ?>
