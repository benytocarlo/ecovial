...
<div class="page-content">	
        ...
        <center>
          <table width="200" border="0">
            <tr>
              <td><strong>Guía Cliente ECOVIAL</strong></td>
            </tr>
            <tr>
              <td><table width="404" height="87">
                <tr>
                  <td height="81" bgcolor="#361388"><label> <strong>Numero de Guia</strong>
                    <select name="n_guia" id="n_guia" >
                      <option value="">Elija una Opci&oacute;n</option>
                      <?$sql ="SELECT * FROM pesaje where nula!='si' and cliente='8' order by id desc";
                  ...
                  <td bgcolor="#361388"><input type="submit" class="formbutton" value="Siguiente" /></td>
                  </tr>
              </table></td>
               </form>
            </tr>
