			...
			<table width="696" border="0">
              <tr>
                ...
                <td width="632"><table width="614" height="418" border="0">
                  <tr>
                    <td align="center"><p><a href="../../sistemamixvial/ADMIN/index.php">Ir a Sistema Mixvial <br />
                    Considera hasta el 13-11-2014</a></p>
                    <p><a href="http://localhost/sistemaecovial/admin/index.php">Ir al sistema de Rutas hasta el 25 de agosto</a></p></td>
                  </tr>
                </table></td>
              </tr>
            </table>
