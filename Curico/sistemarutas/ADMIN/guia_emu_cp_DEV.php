...
include("conexion.php");
	...
	$sql="insert into pesaje (temperatura,num_pesaje,patente,fecha_hora,transportista,chofer,peso_bruto,tara,obra,n_orden,cliente,tipo_guia) values ('$temperatura','$num_pesaje','$patente','$fecha','$transportista','$chofer','$peso','$tara','$obra','$odcompra','$cliente','emulsion')";
