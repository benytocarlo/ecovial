...
<div class="page-content">	
			<!-- CONTENT -->
            	<form action="orden_compra_update.php" method="post" name="form" id="form"  target="_blank">
...
<tr>
                        <td width="208" height="81"><strong>Forma de Pago</strong>
                          <input name="forma_pago" type="text" id="forma_pago" value="<? echo  $forma_pago; ?>" size="40" /></td>
            <td width="219"><strong>Plazo de entrega</strong>
              <input name="plazo_entrega" type="text" id="plazo_entrega" value="<? echo $plazo_entrega; ?>" size="30" ¿/></td>
            </tr>
                    </table>	
        <table width="658" border="0">
          <tr>
            <td width="648"><strong>Observaciones</strong><br>
              <label>
              <textarea name="observaciones" id="observaciones" cols="65" rows="7"><? echo $observacion; ?></textarea>
              <br />
              <br />
