...
include("conexion.php");
	...
	$sql="insert into pesaje (patente,fecha_hora,transportista,chofer,obra,cliente,tipo_guia,peso_bruto,tara,num_pesaje,partidacontrol ) 
	values ('$patente','$fecha','$transportista','$chofer','$obra','$cliente','emulsion','$peso','$tara','$n_pesaje','$partidacontrol')";
