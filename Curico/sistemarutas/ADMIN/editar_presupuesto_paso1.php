...
$sql="SELECT * FROM presupuesto where id='".$num_orden."'";
...
<tr>
                        <td width="674" height="81"><strong>N° Presupuesto</strong><br />
                          <input name="num_presupuesto" type="text" id="num_presupuesto" size="10" readonly="readonly" value="<? echo $num_orden; ?>"/></td>
            </tr>
                      <tr>
