...
<div class="page-content">	
 ...
 <tr>
                      ...
                      <tr>
                       ...
                       <option value="">Elija una Opci&oacute;n</option>
                       <option value="Caldera Curico">Caldera</option>
                          <option value="Cargador Frontal Curico">Cargador Frontal</option>
                          <option value="Generador Curico">Generador</option>
                            <option value="Limpieza Curico">Limpieza</option><br />
                          <option value="Planta Curico">Quemador Planta</option>
                        <option value="Quemador Curico">Quemador Portatil</option>
                        	<option value="Secador Curico">Secador</option>
                         </select></td>
                      </tr>
                        <tr>
