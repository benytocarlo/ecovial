...
<div align="center" class="Estilo7" > 
  <blockquote>
    ...
    <table width="720" border="0" align="center">
          <tr>
            <td><div align="center"><span class="Estilo2">INFORME <br>
            EQUIPO POR PERÍODO</span></div></td>
  ...
  <form name="form1" method="post" action="informe_fact_equipo_por_periodo2.php" target="_blank">
    <br>
