...
<div align="center" class="Estilo7" > 
    ...
    <p>
      <center>
        ...
        <table width="720" border="0" align="center">
          <tr>
            <td><div align="center"><font color="#000000" size="5" face="Trebuchet MS" class="fondo1"><b>INFORME DE EQUIPO </b></font><b><font color="#000000" size="5" face="Trebuchet MS"> POR OBRA</font></b></div></td>
  ...
  <form name="form1" method="post" action="informe_equipo_obra2.php" target="_blank">
...
mysql_select_db("rutas_sistema_avanceobra", $conexion);
    ...
    <tr>
        <td width="41%" height="20" class="texto2_1">Fecha de Inicio<br>
