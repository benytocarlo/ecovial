...
$sql = "select * from petroleo_ecomaq where proveedor='$proveedor' and cliente='$cliente' and fecha between '$fecha_inicio' and '$fecha_termino' order by fecha asc";
...
<center>
  ...
  PETR&Oacute;LEO </font></b></font><b><font color="#000000" size="5" face="Arial, Helvetica, sans-serif">DE PLANTA POR CLIENTE</font></b></p>
      <p>&nbsp;</p>
...
<td width="52"><div align="center">Patente</div></td> 
...
//$horas_fact=0;
	...
	//					$suma2=$suma2+$horas_fact;
				echo "<tr>";
		echo"<td>$fecha</td><td>$guia</td><td>$eqcam</td><td>$horo</td><td>$litros</td>";
     	echo "</tr>";	      
         }?>  
                  <tr>
        <td>&nbsp;</td>
