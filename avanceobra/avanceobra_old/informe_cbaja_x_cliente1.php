...
<div align="center" class="Estilo7" > 
  <blockquote>
    ...
    <table width="720" border="0" align="center">
          <tr>
            <td><div align="center"><span class="Estilo2">INFORME CAMAS BAJA POR CLIENTE</span></div></td>
  ...
  <form name="form1" method="post" action="informe_cbaja_x_cliente2.php" target="_blank">
    <br>
