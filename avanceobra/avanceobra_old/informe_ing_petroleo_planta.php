...
<div align="center" class="Estilo7" > 
  ...
  <form name="form1" method="post" action="informe_ing_petroleo_planta2.php" target="_blank">
    <br>
    <table width="57%" border="0" align="center">
      ...
      <tr>
        <td height="20" class="texto2_1"><div align="right" class="Estilo12">Planta</div></td>
        <td class="texto2_1"><select name="destino" id="destino" >
...
mysql_select_db("rutas_sistema_avanceobra", $conexion);
			...
			$result=mysql_query("select distinct (destino) from petroleo where destino!=' ' order by destino asc",$conexion);
