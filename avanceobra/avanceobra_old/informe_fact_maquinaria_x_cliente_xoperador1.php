...
<div align="center" class="Estilo7" > 
  <blockquote>
    ...
    <table width="720" border="0" align="center">
          <tr>
            ...
            M&Aacute;QUINA POR CLIENTE</span></div></td>
  ...
  <form name="form1" method="post" action="informe_fact_maquinaria_x_cliente_xoperador2.php" target="_blank">
    <br>
    <table width="57%" border="0" align="center">
      <tr> 
        <td width="33%" class="texto2_1"><div align="right"><strong>Seleccione 
            M&aacute;quina :</strong> </div></td>
        <td width="27%"><select name="equipo" id="equipo" >
...
mysql_select_db("rutas_sistema_avanceobra", $conexion);
      ...
      <tr>
        <td height="20" class="texto2_1"><div align="right"><strong>Seleccione Cliente</strong></div></td>
