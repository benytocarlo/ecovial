...
$sql = "select * from petroleo_transvial where fecha between '$fecha_inicio' and '$fecha_termino' order by fecha asc";
...
<center>
      <p><span class="Estilo2">INFORME GENERAL PETROLEO</span></p>
...
<table width="477" border="0">
    ...
    <table width="682" border="1">
      <tr>
        <td width="96"><div align="center"><font size="4" face="Trebuchet MS">Fecha</font></div></td>
		<td width="174"><div align="center"><strong><font face="Trebuchet MS">Chofer</font></strong></div></td>
        <td width="116"><div align="center"><font face="Trebuchet MS"><strong>Patente</strong></font></div></td>
		<td width="85"><div align="center"><font face="Trebuchet MS"><strong>Cant. Litros</strong></font></div></td>
        <td width="90"><div align="center"><font face="Trebuchet MS"><strong>Precio x Litro</strong></font></div></td>
        <td width="81"><div align="center"><font face="Trebuchet MS"><strong>Precio Total</strong></font></div></td>
     </tr>
...
$horas_fact=0;
				...
				echo "<tr>";
		echo"<td>$fecha</td><td>$chofer</td><td>$patente</td><td>$litros</td><td>$precio</td><td>$tprecio</td>";
     	echo "</tr>";	      
         }?>  
                  <tr>
        <td>&nbsp;</td>
