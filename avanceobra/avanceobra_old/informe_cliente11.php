...
<table width="720" border="0" align="center">
  <tr>
    <td class="Estilo7"><div align="center"><span class="Estilo8">INFORME <br>
      PETR&Oacute;LEO POR CLIENTE</span></div></td>
...
<div align="center" class="Estilo7" > 
  ...
  <form name="form1" method="post" action="informe_cliente22.php" target="_blank">
    <br>
    <table width="57%" border="0" align="center">
      ...
      <tr>
        <td height="20" class="texto2_1"><div align="right" class="Estilo12">Cliente</div></td>
        <td class="texto2_1"><select name="cliente" id="cliente" >
