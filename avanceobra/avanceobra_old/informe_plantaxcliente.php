...
<table width="720" border="0" align="center">
  <tr>
    <td class="Estilo7"><div align="center"><span class="Estilo8">INFORME <br>
      PETR&Oacute;LEO DE PLANTA <br>
      POR CLIENTE</span></div></td>
...
<div align="center" class="Estilo7" > 
  ...
  <form name="form1" method="post" action="informe_plantaxcliente2.php" target="_blank">
    <br>
    <table width="57%" border="0" align="center">
      <tr>
        <td class="texto2_1"><span class="Estilo12"> Planta</span></td>
        <td><span class="texto2_1">
...
mysql_select_db("rutas_sistema_avanceobra", $conexion);
      ...
      <tr> 
        <td width="33%" class="texto2_1"><span class="Estilo12">Cliente</span></td>
        <td width="27%"><span class="texto2_1">
...
mysql_select_db("rutas_sistema_avanceobra", $conexion);
			...
			$result=mysql_query("select distinct (cliente) from petroleo_ecomaq where cliente!=' ' order by cliente asc",$conexion);
      ...
      <tr>
        <td height="20" class="texto2_1"><div align="right" class="Estilo12"></div></td>
    ...
    <table width="44%" border="0" align="center">
      <tr>
        ...
        <td width="42%" class="texto2_1"><span class="Estilo12"><br>
          Fecha de Termino</span><br>
