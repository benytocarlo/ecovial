...
$sql = "select * from petroleo where destino='$destino' and fecha between '$fecha_inicio' and '$fecha_termino' order by fecha asc";
...
<table width="451" border="0">
        <tr>
          <td width="130">Destino:</td>
          <td width="695"><?php echo $destino; ?></td>
        </tr>
        <tr>
          <td>Desde:</td>
...
//$horas_fact=0;
	...
	//					$suma2=$suma2+$horas_fact;
				echo "<tr>";
		echo"<td>$fecha</td><td>$guia</td><td>$proveedor</td><td>$litros</td>";
     	echo "</tr>";	      
         }?>  
                  <tr>
        <td>&nbsp;</td>
