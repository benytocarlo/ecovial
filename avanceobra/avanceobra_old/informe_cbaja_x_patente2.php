...
$sql = "select * from control_cama where patente='$patente' and fecha between '$fecha_inicio' and '$fecha_termino' order by fecha asc";
...
<center>
      <p><font color="#000000" size="5" face="Trebuchet MS" class="fondo1"><b>INFORME  CAMAS BAJA POR PATENTE</b></font></p>
...
$horas_fact=0;
				...
				echo "<tr>";
		echo"<td>$fecha</td><td>$report</td><td>$guia</td><td>$obra_transvial</td><td>$precio</td><td>$chofer</td>";
     	echo "</tr>";	      
         }?>  
                  <tr>
        <td>&nbsp;</td>
