...
$sql = "select * from control_cama where cliente='$cliente' and fecha between '$fecha_inicio' and '$fecha_termino' order by fecha asc";
...
<center>
      <p><font color="#000000" size="5" face="Trebuchet MS" class="fondo1"><b>INFORME  CAMAS BAJA POR CLIENTE</b></font></p>
...
<table width="477" border="0">
    ...
    <table width="960" border="1">
      <tr>
        ...
        <td width="170"><div align="center"><font face="Trebuchet MS"><strong>Chofer</strong></font></div></td>
     </tr>
...
$horas_fact=0;
				...
				echo "<tr>";
		echo"<td>$fecha</td><td>$report</td><td>$guia</td><td>$obra_transvial</td><td>$precio</td><td>$patente</td><td>$chofer</td>";
     	echo "</tr>";	      
         }?>  
                  <tr>
        <td>&nbsp;</td>
