...
<table width="720" border="0" align="center">
  <tr>
    <td class="Estilo7"><div align="center"><span class="Estilo8">INFORME <br>
      PETR&Oacute;LEO POR PROVEEDOR</span></div></td>
...
<div align="center" class="Estilo7" > 
  ...
  <form name="form1" method="post" action="informe_ing_petroleo_proveedor2.php" target="_blank">
    <br>
...
mysql_select_db("rutas_sistema_avanceobra", $conexion);
			...
			$result=mysql_query("select distinct (residente) from mantenedor where residente!=' ' order by residente asc",$conexion);
