...
<div align="center" class="Estilo7" > 
  <blockquote>
    ...
    <table width="720" border="0" align="center">
          <tr>
            <td><div align="center"><span class="Estilo2">INFORME CAMAS BAJA POR PATENTE</span></div></td>
  ...
  <form name="form1" method="post" action="informe_cbaja_x_patente2.php" target="_blank">
    <br>
...
mysql_select_db("rutas_sistema_avanceobra", $conexion);
			...
			$result=mysql_query("select distinct patente from control_cama order by patente asc",$conexion);
