...
if ($_POST['action'] == "add") { 
	...
	//bandera=venta
	$que = "INSERT INTO control_dia (fecha, nombre_obra, eq_asfalto, mezcla, m3, eq_maq_fre, eq_maq_maf, m2_fresado, m2_maf) ";
	$que.= "VALUES ('".$_POST['fecha']."', '".$_POST['nombre_obra']."', '".$_POST['eq_asfalto']."', '".$_POST['mezcla']."', '".$_POST['m3']."', '".$_POST['eq_maq_fre']."', '".$_POST['eq_maq_maf']."', '".$_POST['m2_fresado']."', '".$_POST['m2_maf']."') ";
...
<table width="720" border="0" align="center">
          <tr>
            <td><div align="center"><span class="Estilo2">REGISTRO FRESADO Y SLURRY <br /> 
...
<table width="627" border="0" align="center">
  ...
  <tr>
    ...
    <td colspan="2"><input type="text" name="fecha" id="fecha" /></td>
  </tr>
<select name="bandera" id="bandera" hidden>
  ...
  <tr>
    <td><strong>M2 Fresado</strong></td>
    <td width="127"><input name="m2_fresado" type="text" id="m2_fresado" size="10" /></td>
    <td width="312"><select name="eq_maq_fre" id="eq_maq_fre" >
      <option > </option>
      <?php
    			$conexion = mysql_connect("localhost", "rutas_sistemas", "7RJWmWVxDfFo");
			mysql_select_db("rutas_sistema_avanceobra", $conexion);
   			
			$result=mysql_query("select eq_maq_fre from mantenedor where eq_maq_fre!=' ' order by eq_maq_fre asc",$conexion);
  ...
  <tr>
    <td><div align="left"><strong>M2 Slurry</strong></div></td>
    <td>
      <div align="left">
        <input name="m2_maf" type="text" id="m2_maf" size="10" />
      </div></td>
    <td><select name="eq_maq_maf" id="eq_maq_maf" >
      <option > </option>
      <?php
    			$conexion = mysql_connect("localhost", "rutas_sistemas", "7RJWmWVxDfFo");
			mysql_select_db("rutas_sistema_avanceobra", $conexion);
   			
			$result=mysql_query("select eq_maq_maf from mantenedor where eq_maq_maf!=' ' order by eq_maq_maf asc",$conexion);
