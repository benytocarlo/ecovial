...
$sql = "select * from petroleo_ecomaq where eqcam='$eqcam' and fecha between '$fecha_inicio' and '$fecha_termino' order by fecha asc";
...
<center>
  ...
  PETR&Oacute;LEO </font></b></font><b><font color="#000000" size="5" face="Arial, Helvetica, sans-serif">POR PATENTE</font></b> </p>
      <p>&nbsp;</p>
<table width="451" border="0">
        <tr>
          <td width="130">Patente:</td>
          <td width="695"><?php echo $eqcam; ?></td>
        </tr>
        <tr>
          <td>Desde:</td>
...
<form name="form1" method="post" action="informe_proveedores2.php" target="_blank">
  <table width="947" border="1">
      <tr>
        ...
        <td width="52"><div align="center"><font size="3" face="Arial, Helvetica, sans-serif">Odómetro</font></div></td>
...
//$horas_fact=0;
	...
	//					$suma2=$suma2+$horas_fact;
				echo "<tr>";
		echo"<td>$fecha</td><td>$report</td><td>$horo</td><td>$obra</td><td>$opecho</td><td>$proveedor</td><td>$litros</td>";
     	echo "</tr>";	      
         }?>  
                  <tr>
        <td>&nbsp;</td>
