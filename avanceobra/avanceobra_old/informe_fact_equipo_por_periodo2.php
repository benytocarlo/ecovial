...
<table width="477" border="0">
    ...
    <table width="1000" border="1">
      <tr>
        ...
        <td width=""><font face="Trebuchet MS"><strong>Operador</strong></font></td>
...
$horas_fact=0;
				...
				echo "<tr>";
		echo"<td>$fecha</td><td>$report</td><td>$horas</td><td>$horas_fact</td><td>$operador</td><td>$obra</td>";
     	echo "</tr>";	      
         }?>  
                  <tr>
        <td>&nbsp;</td>
