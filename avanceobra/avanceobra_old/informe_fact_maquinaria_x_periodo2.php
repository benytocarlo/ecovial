...
$sql = "select * from control_equipos where equipo='$equipo' and fecha between '$fecha_inicio' and '$fecha_termino' order by fecha asc";
...
<center>
      <p><font color="#000000" size="5" face="Trebuchet MS" class="fondo1"><b>INFORME  FACTURACIÓN MAQUINA POR PERÍODO</b></font></p>
...
<table width="477" border="0">
    ...
    <table width="960" border="1">
      <tr>
        ...
        <td width="435"><div align="center"><strong><font face="Trebuchet MS">Cliente</font></strong></div></td>
...
$horas_fact=0;
				...
				echo "<tr>";
		echo"<td>$fecha</td><td>$report</td><td>$horas</td><td>$horas_fact</td><td>$obra</td><td>$cliente</td>";
     	echo "</tr>";	      
         }?>  
                  <tr>
