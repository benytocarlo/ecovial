...
<center>
      <p><font color="#000000" size="5" face="Trebuchet MS" class="fondo1"><b><font face="Arial, Helvetica, sans-serif">INFORME   FACTURACI&Oacute;N 
  PETR&Oacute;LEO </font></b></font><b><font color="#000000" size="5" face="Arial, Helvetica, sans-serif">POR</font></b><font color="#000000" size="5" face="Arial, Helvetica, sans-serif" class="fondo1"><b> CLIENTE</b></font></p>
      <p>&nbsp;</p>
...
<form name="form1" method="post" action="informe_proveedores2.php" target="_blank">
  <table width="947" border="1">
      <tr>
        ...
        <td width="166"><div align="center"><font size="3" face="Arial, Helvetica, sans-serif">Equipo</font></div></td>
...
//$horas_fact=0;
	...
	//					$suma2=$suma2+$horas_fact;
				echo "<tr>";
		echo"<td>$fecha</td><td>$report</td><td>$obra</td><td>$opecho</td><td>$eqcam</td><td>$litros</td>";
     	echo "</tr>";	      
         }?>  
                  <tr>
        <td>&nbsp;</td>
