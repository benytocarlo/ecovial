...
mysql_select_db("rutas_sistema_avanceobra", $conexion);
	...
	//bandera=venta
	$que = "INSERT INTO control_cama (fecha, report, guia, cliente, obra_transvial, origen, odo_ini, destino, odo_ter, chofer, patente, precio) ";
	$que.= "VALUES ('".$_POST['fecha']."', '".$_POST['report']."', '".$_POST['guia']."', '".$_POST['cliente']."', '".$_POST['obra_transvial']."', '".$_POST['origen']."', '".$_POST['odo_ini']."', '".$_POST['destino']."', '".$_POST['odo_ter']."', '".$_POST['chofer']."', '".$_POST['patente']."', '".$_POST['precio']."') ";
//	echo $que;
...
<table width="720" border="0" align="center">
          <tr>
            <td><div align="center"><span class="Estilo2">REGISTRO REPORT CAMA BAJA<br /> 
              TRANSVIAL Ltda.
</span></div></td>
...
<form id="insertar" name="insertar" method="post" action="">
  ...
  <tr>
    <td width="162"><strong>Fecha de Trabajo</strong></td>
    <td width="344" colspan="2"><input type="text" name="fecha" id="fecha" /></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><strong>Nro. Guía Traslado</strong></td>
...
mysql_select_db("rutas_sistema_avanceobra", $conexion);
  ...
  <tr>
    <td><strong>Origen</strong><strong></strong></td>
    <td colspan="2"><input name="origen" type="text" id="origen" size="50" /></td>
  </tr>
  <tr>
    <td><strong>Odómetro Inicio</strong></td>
    <td colspan="2"><input name="odo_ini" type="text" id="odo_ini" size="10" /></td>
  </tr>				
  <tr>
    <td><strong>Destino</strong></td>
    <td colspan="2"><input name="destino" type="text" id="destino" size="50" /></td>
  </tr>
  <tr>
    <td><strong>Odómetro Término</strong></td>
    <td colspan="2"><input name="odo_ter" type="text" id="odo_ter" size="10" /></td>
  </tr>
  <tr>
...
mysql_select_db("rutas_sistema_avanceobra", $conexion);
  ...
  <tr>
    <td><strong>Precio Total Acordado</strong></td>
