  ...
  <blockquote>
    <p>
      ...
      <center class="Estilo6">
        ...
        <p><strong><font size="5" face="Trebuchet MS"> Informe</font></strong></p>
    </center>
    </blockquote>
  <form name="form1" method="post" action="informe_operador_horas2v2.php" target="_blank">
    <font color="#000000"><br>
    </font>
    <table width="66%" border="0" align="center">
      <tr> 
        <td width="35%" class="texto2_1"><div align="right" class="Estilo6"><strong>Seleccione 
...
mysql_select_db("ecovialc_avance", $conexion);
			...
			$result=mysql_query("select distinct (operador) from mant_maqtra where operador!=' ' order by operador asc",$conexion);
			//echo $result;
...
mysql_select_db("ecovialc_avance", $conexion);
	  ...
	  <tr>
	    <td align="right" class="texto2_1">Descuento Horas al Trato</td>
	    <td><input type="text" name="descuento" id="descuento"></td>
	    <td>&nbsp;</td>
	    </tr>
	  <tr>
	    <td align="right" class="texto2_1">Dias Vendidos Cantidad</td>
	    <td><input type="text" name="cant_vendida" id="cant_vendida">
         Monto</td>
	    <td><input type="text" name="cant_valor" id="cant_valor"></td>
	    </tr>
    </table>
    <p>&nbsp;</p>
