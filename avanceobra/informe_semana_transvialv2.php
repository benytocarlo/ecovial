...
$fecha_inicio_aux	= $fecha1." 00:00:01";
$fecha_final_aux	= $fecha2." 23:59:59";

$sql = "select * from control_tolvas where chofer='$chofer' and fecha  between '$fecha_inicio_aux' and '$fecha_final_aux' order by fecha asc";
//echo $sql;
...
$sql2 = "select * from petroleo_ecomaq where opecho='$chofer' and fecha between '$fecha1' and '$fecha2' order by fecha asc";
//$sql = "select * from datos where cliente='$cliente' and  fecha  between '$fecha_inicio' and '$fecha_termino' ";
//echo $sql;
...
<div align="center" > 
  ...
  <center>
    <p><font color="#000000"><strong><font size="5" face="Trebuchet MS">INFORME POR CHOFER TOLVA</font></strong></font></p>
  </center>
  <table width="841" border="0">
    ...
    <tr>
      <td>Desde:</td>
      <td colspan="4"><?php echo $fecha1; ?></td>
    </tr>
    <tr>
      <td>Hasta:</td>
      <td colspan="4"><?php echo $fecha2; ?></td>
    </tr>
    <tr>
...
$horas_fact=0;
				...
				echo "<tr>";
		echo"<td>$fecha</td><td>$report</td><td>$guia</td><td>$patente</td><td>$sumita</td>";
     	echo "</tr>";	      
         }?>
           <tr>
 ...
 <td></td>
       ...
       <td align="center"><strong>PETR&Oacute;LEO</strong><br>
         ...
         <tr>
             ...
             <td width=""><div align="center"><font size="4" face="Trebuchet MS">Report</font></div></td>
...
$horas_fact=0;
					...
					//	$suma2=$suma2+$horas_fact;
				echo "<tr>";
		echo"<td>$fecha</td><td>$report</td><td>$eqcam</td><td>$litros</td><td>$precio</td><td>$tprecio</td>";
     	echo "</tr>";	      
         }?>
           <tr>
             ...
             <td colspan="4"><strong>Totales</strong></td>
              <td>&nbsp;</td>
               <td colspan="4"><strong><?php echo number_format($tprecio2, 0, ',', '.'); ?></strong></td>
