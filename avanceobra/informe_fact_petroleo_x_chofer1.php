...
<table width="720" border="0" align="center">
  <tr>
    <td class="Estilo7"><div align="center"><span class="Estilo8">INFORME <br>
      PETR&Oacute;LEO POR CHOFER</span></div></td>
    <td class="Estilo7"><div align="center"><img src="rutas_small.jpg" width="191" height="84"></div></td>
  </tr>
</table>
<div align="center" class="Estilo7" > 
  ...
  <form name="form1" method="post" action="informe_fact_petroleo_x_chofer2.php" target="_blank">
    <br>
    <table width="57%" border="0" align="center">
      ...
      <tr>
        <td height="20" class="texto2_1"><div align="right" class="Estilo12">Chofer</div></td>
        <td class="texto2_1"><select name="opecho" id="opecho" >
...
mysql_select_db("rutas_sistema_avanceobra", $conexion);
			...
			$result=mysql_query("select distinct (opecho) from mant_maqtra where opecho!=' ' order by opecho asc",$conexion);
			//echo $result;
