...
<div align="center" class="Estilo7" > 
  <blockquote>
    ...
    <table width="720" border="0" align="center">
          <tr>
            <td><div align="center"><span class="Estilo2">INFORME GENERAL PETROLEO</span></div></td>
  ...
  <form name="form1" method="post" action="informe_petroleo_gral2.php" target="_blank">
    <br>
    <br>
