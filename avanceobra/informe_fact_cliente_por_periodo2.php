...
$sql = "select * from control_equipos where cliente='$cliente' and fecha between '$fecha_inicio' and '$fecha_termino' order by fecha asc";
...
EQUIPO POR PERÍODO FILTRO CLIENTE</span></p>
...
$horas_fact=0;
				...
				echo "<tr>";
		echo"<td>$fecha</td><td>$report</td><td>$horas</td><td>$horas_fact</td><td>$equipo</td><td>$obra</td>";
     	echo "</tr>";	      
         }?>  
                  <tr>
        <td>&nbsp;</td>
