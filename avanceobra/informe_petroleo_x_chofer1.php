...
<div align="center" class="Estilo7" > 
  <blockquote>
    ...
    <table width="720" border="0" align="center">
          <tr>
            <td><div align="center"><span class="Estilo2">INFORME PETROLEO POR CHOFER</span></div></td>
  ...
  <form name="form1" method="post" action="informe_petroleo_x_chofer2.php" target="_blank">
    <br>
    <table width="57%" border="0" align="center">
      <tr>
        <td width="33%" height="20" class="texto2_1"><div align="right"><strong>Seleccione Chofer</strong></div></td>
...
mysql_select_db("rutas_sistema_avanceobra", $conexion);
			...
			$result=mysql_query("select chofer from mant_maqtra order by cliente asc",$conexion);
