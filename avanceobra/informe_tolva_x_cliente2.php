...
$sql = "select * from control_tolvas where cliente='$cliente' and fecha between '$fecha_inicio' and '$fecha_termino' order by guia asc";
...
$horas_fact=0;
				...
				echo "<tr>";
		echo"<td>$fecha</td><td>$report</td><td>$guia</td><td>$m3</td><td>$multi</td><td>$patente</td><td>$chofer</td><td>$obra</td>";
     	echo "</tr>";	      
         }?>  
                  <tr>
        <td>&nbsp;</td>
