...
mysql_select_db("rutas_sistema_avanceobra", $conexion);
	...
	$que.= "VALUES ('".$_POST['fecha']."', '".$_POST['report']."', '".$_POST['operador']."', '".$_POST['equipo']."', '".$_POST['obra']."', '".$_POST['horas']."', '".$_POST['cliente']."', '".$_POST['h_termino']."') ";
//	echo $que;
...
<table width="720" border="0" align="center">
          <tr>
            <td><div align="center"><span class="Estilo2">REGISTRO REPORT EQUIPOS<br /> 
...
mysql_select_db("rutas_sistema_avanceobra", $conexion);
  ...
  <tr>
    ...
    <td colspan="2"><input name="horas" type="text" id="horas" size="10" /> 
      <strong>Hora Termino</strong>      <input name="h_termino" type="text" id="h_termino" size="10" /></td>
  </tr>				
  <tr>
