...
$sql = "select * from control_tolvas where chofer='$chofer' and obra_transvial='$obra' and fecha between '$fecha_inicio' and '$fecha_termino' order by fecha asc";
...
<center>
      <p><font color="#000000" size="5" face="Trebuchet MS" class="fondo1"><b>INFORME  TOLVAS POR CHOFER</b></font></p>
...
$horas_fact=0;
				...
				echo "<tr>";
		echo"<td>$fecha</td><td>$report</td><td>$guia</td><td>$m3</td><td>$multi</td><td>$patente</td><td>$cliente</td><td>$obra</td>";
     	echo "</tr>";	      
         }?>  
                  <tr>
        <td>&nbsp;</td>
