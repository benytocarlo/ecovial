...
$sql = "select * from control_equipos where equipo='$equipo' and cliente='$cliente' and operador='$operador' and fecha between '$fecha_inicio' and '$fecha_termino' order by fecha asc";
