...
$sql = "select * from control_equipos where equipo='$equipo' and operador='$operador' and fecha between '$fecha_inicio' and '$fecha_termino' order by fecha asc";
...
<center>
      <p>&nbsp;</p>
      <p><font color="#000000" size="5" face="Trebuchet MS" class="fondo1">	 <b>INFORME DE EQUIPO  </b></font><b><font color="#000000" size="5" face="Trebuchet MS"> POR OPERADOR</font></b></p>
...
//$horas_fact=0;
	...
	//					$suma2=$suma2+$horas_fact;
				echo "<tr>";
		echo"<td>$fecha</td><td>$report</td><td>$horas</td><td>$obra</td><td>$cliente</td>";
     	echo "</tr>";	      
         }?>  
                  <tr>
