...
<table width="720" border="0" align="center">
  <tr>
    <td class="Estilo7"><div align="center"><span class="Estilo8">INFORME <br>
      PETR&Oacute;LEO POR PATENTE</span></div></td>
...
<div align="center" class="Estilo7" > 
  ...
  <form name="form1" method="post" action="informe_plantaxpatente2.php" target="_blank">
    <br>
    <table width="57%" border="0" align="center">
      <tr> 
        <td width="33%" align="right" class="texto2_1"><span class="Estilo12">Planta</span></td>
...
mysql_select_db("rutas_sistema_avanceobra", $conexion);
      ...
      <tr>
        <td height="20" class="texto2_1"><div align="right" class="Estilo12">Patente</div></td>
        <td class="texto2_1"><select name="eqcam" id="eqcam" >
...
mysql_select_db("rutas_sistema_avanceobra", $conexion);
			...
			$result=mysql_query("select distinct (eqcam) from mant_maqtra where eqcam!=' ' order by eqcam asc",$conexion);
			//echo $result;
