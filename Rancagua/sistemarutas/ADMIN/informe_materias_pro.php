...
<div class="content">
		...
		<div class="page-content">	
			<p>
			  <!-- CONTENT -->
		      <span class="Estilo1">Informe por<strong> Materias Primas por Proveedor</strong></span></p>
	        <table width="696" border="0">
              <tr>
                <td width="21" height="258"><p class="clear">&nbsp;</p>
                </td>
                <td width="665"><form id="form1" method="post" action="informes/inf_materia_pro.php" target="_blank" >
