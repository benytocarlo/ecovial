...
<div class="content">
		...
		<div class="page-content">	
			<p>
			  <!-- CONTENT -->
		      <span class="Estilo1">Informe por Reingreso de Emulsiones</span></p>
	        <table width="696" border="0">
              <tr>
                <td width="21" height="258"><p class="clear">&nbsp;</p>
                </td>
                <td width="665"><form id="form1" method="post" action="informes/inf_reingreso.php" target="_blank" >
                  <table width="611" height="182" border="0">
                    <tr>
                      <td width="136" height="43"><strong>Materia Prima</strong></td>
<td width="465"><label></label>
  <div id="select_cliente">
    <select name="materia" id="materia">
      <option value="">Elija una Opci&oacute;n</option>
      <?$sql ="SELECT * FROM mezclas ml, devoluciones dv where dv.id_materia=ml.id order by ml.nombre asc";
      ...
      <?}?>
                    ...
                    <tr>
                      ...
                      <td><input name="fecha_inicio" type="text" class="Estilo2" readonly="readonly" />
                    ...
                    <tr>
                      ...
                      <td><input type="text" readonly="readonly" name="fecha_final" class="Estilo2"/>
