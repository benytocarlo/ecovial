...
<div class="wrapper">
  ...
  <div class="page-content">	
        ...
        <center>
<table width="676" height="438" align="center">
<tr>
              <td width="312" height="81"><strong>Patente</strong> <br />
            ...
            <td width="174"><strong>N&deg; Pesaje</strong><br />
               <!-- <input name="n_pesaje" type="text" id="n_pesaje" size="8" />
                <input type="button" name="calcular" class="formbutton2"  value="Buscar" id="calcular" onclick="xajax_buscarpesaje(document.form.n_pesaje.value)"/> -->           
			...
			<td width="174"><strong>Tara</strong> <br />
                <input name="tara" type="text" id="tara" size="10" readonly="readonly"/></td>
                      ...
                      <td id="peso_brutoid"><strong>Peso Bruto</strong>
