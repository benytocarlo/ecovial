...
$result4 = mysql_query($sql4); 
 while($row = mysql_fetch_row($result4))
	...
	$sql="insert into ingreso_petroleo(fecha, vale, item, r_planta, patente, e_asfalto, producto, chofer, litros, odo, cliente) values ('$fecha','$vale','$item','$r_planta','$patente','$equipo', '$producto', '$chofer', '$litros', '$odo', '$cliente')";
