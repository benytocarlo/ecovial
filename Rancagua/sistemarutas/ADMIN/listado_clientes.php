...
<div class="wrapper">
	...
	<div class="content">
		...
		<div class="page-content">	
			<!-- CONTENT -->
			<span class="Estilo1">Listado de Clientes</span>
			<fieldset>
				<legend></legend>
		<form id="form" action="actualizar.php?id=<?echo $id; ?>&oculto=cliente" method="get">
				    <table>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td><table width="94" border="0" align="center">
                          <tr>
                            <td width="46" ><a href="editar_cliente.php?id=<? echo $row[0]; ?>"><img src="images/001_45.png" alt="" width="24" height="24" border="0" /></a></td>
                            <td width="64"><a href="eliminar.php?id=<? echo $row[0]; ?>&oculto=cliente"><img src="images/001_05.png" alt="" width="24" height="24" border="0" /></a></td>
                          </tr>
                        </table></td>
                      </tr>
                      <? } ?>
