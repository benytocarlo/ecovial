...
$sql="update orden_compra set forma_de_pago='$forma_de_pago' ,plazo_entrega='$plazo_entrega',observaciones='$observaciones' where id=$num_orden";
...
<table width="861" border="0" align="center">
  <tr>
				   ...
				   $suma=0;
				    $sql_list ="select * from detalle_orden_compra where id_orden_compra=".$num_orden."";
					  ...
					  $centrocc=$row[8];
                        ...
                        <td><div align="right">$ <? echo number_format($row[6], 0, '', '.'); ?> </div></td>
                  </tr>
                  <? } ?>
                </table></td>
            </tr>
                ...
                <tr>
                  <td nowrap="nowrap">% Dcto.:</td>
                   <td align="right">	<?if($descuento){ ?>
						<?  $des=($descuento*100)/$total_neto;
						$tdesc=100-$des;
						echo number_format($tdesc, 3); ?> %
						<?} else{ ?>
						0%
						<? } ?>
						</td>
        ...
        <td height="105"><p>&nbsp;</p>
          ...
          <tr>
            <td><div align="center">___________________________</div>
              <div align="center">
                &nbsp;&nbsp;&nbsp;<label> 
                <input name="textfield" type="text" id="textfield" value="Juan Carlos Yevenes" size="30" style="border:0px"/>
                </label>
              </div>
              <div align="center">
   ...
   <div align="center" style="font-size:15px !important">Mixvial Ltda. <br />
76.236.020-9 <br />
Hijuela 10 Lota A Maquehua <br />
Fono (75)544076 - recepcion@mixvial.cl
 <br />
Curicó</div>
          </td>
      </tr>
