...
<?		 
		 $sql2="select * from ingreso_materias ing_mat, materias mat, camiones cam where ing_mat.fecha_guia  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."' and ing_mat.proveedor=".$proveedor." and ing_mat.materia=mat.id and ing_mat.patente=cam.id order by ing_mat.fecha_guia asc,  ing_mat.guia asc";
//	 echo $sql2;
		  $sumacantidad=0;
		  $sumatotal=0;
