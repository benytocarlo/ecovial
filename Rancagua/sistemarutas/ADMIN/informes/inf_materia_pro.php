...
$sql="select * from proveedor where id=".$materia."";
...
<?		 
		 $sql2="select * from ingreso_materias ing_mat, proveedor pro, materias mat where ing_mat.fecha_guia  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."' and ing_mat.proveedor=".$materia."  and ing_mat.nula!='si' and  ing_mat.proveedor=pro.id and ing_mat.materia=mat.id order by ing_mat.fecha_guia ASC";
	//	echo $sql2;
		$sumacantidad=0;
		  $sumatotal=0;
