...
//$cliente=$_POST["nombre_cliente"];
		  ...
		  $sql2last=" select sum(litros) total_litros, obra, producto from detalle_pesaje dp, pesaje pe where pe.fecha_hora  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."' AND pe.cliente='".$cliente."' and pe.id=dp.guia and pe.tipo_guia=' ' and pe.nula!='si' GROUP BY pe.obra ";
