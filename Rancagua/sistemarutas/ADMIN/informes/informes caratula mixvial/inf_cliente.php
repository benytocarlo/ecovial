        ...
        <td width="841" height="98"><table width="841" border="0">
          <tr>
            ...
            <td width="283"><div align="center">
              <p align="center">Ecovial Ltda.<br />
77.580.000-3<br />
...
Curicó</p>
      ...
      <tr>
        ...
        <table width="841" border="1">
		 ...
		 <? $sql2="select * from  pesaje pe, obra ob, detalle_pesaje dp where fecha_hora  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."'  and cliente='".$cliente."' and pe.id=dp.guia and pe.nula!='si' and pe.obra=ob.id order by pe.id asc"  ;
		//	echo $sql2;
		  $sumacantidad=0;
		  $sumatotal=0;
