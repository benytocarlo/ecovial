      ...
      <tr>
        ...
        <table width="841" border="1">
          <tr>
            ...
            <td width="76">Tipo Guia</td>
            </tr>
<?		 
		  $sql2last="select * from pesaje dp, cliente li where dp.fecha_hora  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."' and dp.cliente=li.id and dp.nula!='si' order by dp.id";
										//	echo $sql2last;
		  $sumacantidad=0;
		  $sumatotal=0;
		  $totaltraslado=0;
