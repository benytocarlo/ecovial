    ...
    <td width="851"><table width="851" height="312" border="0">
      <tr>
        <td width="841" height="98"><table width="841" border="0">
          <tr>
            <td width="542" height="138"><table width="542" border="0">
                <tr>
...
Planta Rancagua </strong></div>
      ...
      <tr>
		...
		<center>Ventas </center><br /><table width="845" border="1">
          <tr>
            <td width="597" height="23" align="center">Producto </td>
		...
		<p>Suministro de Petróleo  en Planta <br />
		  </p>
	...
	//	echo $sql22;
		...
		<p>		  Ingresos </p><br /><table width="845" border="1">
          <tr>
