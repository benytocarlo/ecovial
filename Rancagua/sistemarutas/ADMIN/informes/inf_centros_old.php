    ...
    <td width="851" height="333"><table width="851" height="331" border="0">
      ...
      <tr>
        ...
        <table width='845' height="29" border='1'> <tr>
          ...
          <td width="" align="center">Cliente</td>
        </tr>
        <? 
		...
		$full=0;
		$full_2=0;
		$sql2="select distinct (vale), fecha, item, r_planta, patente, e_asfalto, producto, chofer, litros, odo, cliente, obra from ingreso_petroleo  where fecha  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."' order by fecha ASC";
		//echo $sql2;
