      ...
      <tr>
        ...
        <table width="841" border="1">
          <tr>
           ...
           <? $sql23="select * from transportista tra,  pesaje ing_or, cliente cli  ,camiones cam where ing_or.fecha_hora  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."' and ing_or.obra=".$obra." and ing_or.transportista=tra.id and ing_or.cliente=cli.id and ing_or.patente=cam.id and ing_or.nula!='si' and ing_or.tipo_guia='combustible' order by ing_or.id asc";
		//   echo $sql23;
		 $sumacantidad=0;
		  $sumatotal=0;
