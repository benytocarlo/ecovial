...
Planta Rancagua</strong></p></td>
      ...
      <tr>
        <td height="74"><table width="841" border="0">
          <tr>
            ...
            <td width="695"><?php echo $mezclita; ?></td>
          </tr>
          <tr>
            <td>Desde:</td>
 ...
 <? $sql2="select * from  pesaje pesj ,cliente cli, detalle_pesaje dp where pesj.fecha_hora  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."' and pesj.id=dp.guia and pesj.cliente=cli.id and pesj.tipo_guia!='emulsion' and pesj.tipo_guia!='combustible' and pesj.tipo_guia!='traslado' and pesj.nula!='si' order by pesj.id asc ";
		//echo $sql2;
...
<? } } if($tipo_mezcla=="Otro"){  ?>
      ...
      <table width="841" border="1">
          <tr>
          <td width="93" height="24">N° Guia</td>
            <td width="93" height="24">Patente</td>
            <td width="105"><p>Cantidad</p>                </td>
            <td width="91">Precio</td>
            <td width="110">Total</td>
            <td width="161">Fecha</td>
 ...
 <? $sql2last="select * from  pesaje pesj ,cliente cli, camiones cam, obra ob where pesj.fecha_hora  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."' and pesj.cliente=cli.id and pesj.patente=cam.id and pesj.obra=ob.id and pesj.tipo_guia='combustible' and pesj.nula!='si' order by pesj.id asc";
	//echo $sql2last;	
