      ...
      <tr>
        ...
        <table width="841" border="1">
          <tr>
			...
			<td width="50">Patente</td>
          </tr>
		 <? $sql2="select * from  pesaje pe, obra ob, detalle_pesaje dp, camiones cam where fecha_hora  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."'  and cliente='".$cliente."' and pe.patente=cam.id and pe.id=dp.guia and pe.nula!='si' and pe.obra=ob.id and tipo_guia=' ' order by pe.fecha_hora asc"  ;
			//echo $sql2;
		  $sumacantidad=0;
		  $sumatotal=0;
       ...
       <tr>
        ...
        <table width="841" border="1">
          <tr>
           ...
           <? $sql2="select * from pesaje pe,camiones cam, obra ob where pe.fecha_hora  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."' and  cam.id=pe.patente and ob.id=pe.obra and cliente='".$cliente."' and pe.nula!='si' and pe.tipo_guia='emulsion'";
			//echo $sql2;
		   		 $sumatoria=0;
		  $sumatotal=0;
		  $result2 = mysql_query($sql2); 
...
//							echo $sql2list;
          ...
          <table width="841" border="1">
            ...
            <td width="68"></td>
			 <td width="66"><? // echo number_format($sumatoria, 0, '', '.');   ?></td>
