...
var x10 = document.form.valor_mezcla.value;
    ...
    //valido el nombre
    if (x1=="" || x2=="" || x3=="" || x4=="" || x5=="" || x6=="" || x7=="" || x9=="" || x10=="" ){
            ...
            <td><strong>N° de Guía</strong>
              ...
              <? $sql ="SELECT * FROM ingreso_orden order by orden ASC";
                      ...
                      <tr>
                        ...
                        <td id="peso_brutoid"><strong>N° Litros </strong><br />
                            <input name="n_litros" type="text" id="n_litros" size="10"  /></td>
            </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td><input name="button" type="button" class="formbutton" id="guia" onclick="valida()" value="Generar Guia" /></td>
            </tr>
          </table>	
