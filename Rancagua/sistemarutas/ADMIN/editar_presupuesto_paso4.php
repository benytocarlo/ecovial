...
?>
<?
$num_presupuesto=$_POST["n_presupuesto"];
$total_neto=$_POST["total_neto"];
$iva=$_POST["iva"];
$descuento=$_POST["descuento"];
$total_bruto=$_POST["total_bruto"];
$total_descuento=$_POST["total_descuento"];
$sql="update presupuesto set total_neto='$total_neto' ,descuento='$descuento',total_descuento='$total_descuento' ,iva='$iva' ,total_bruto='$total_bruto' where id=$n_presupuesto";
...
<div class="page-content">	
			<!-- CONTENT -->
            	<form action="presupuesto.php" method="post" name="form" id="form" target="_blank">
			<div id="form_pesaje"><span class="Estilo1">Presupuesto
        ...
        <center>
<table width="443" height="152" align="center">
<tr>
                        <td width="208" height="81"><strong>Forma de Pago</strong>
                          <input name="forma_pago" type="text" id="forma_pago" size="30" /></td>
            <td width="219"><strong>Plazo de entrega</strong>
              <input name="plazo_entrega" type="text" id="plazo_entrega" size="30" ¿/></td>
            </tr>
                      <tr>
                        <td height="63" id="mezcla_name"><strong>Validez Presupuesto</strong>
                          <input name="validez" type="text" id="validez" size="30" ¿/></td>
                        <td><strong>Reajustes</strong>
                          <input name="reajustes" type="text" id="reajustes" size="30" ¿/></td>
            </tr>
                    </table>	
        <table width="658" border="0">
          <tr>
            <td width="648"><strong>Observaciones</strong><br>
              ...
              <br />
              <br />
              <input type="submit" name="nuevo_obra2" class="formbutton" value="Finalizar y Generar Presupuesto" id="nuevo_obra2"/>
              </label></td>
          </tr>
        </table>
        <p>&nbsp;</p>
