			...
			<table width="696" border="0">
              <tr>
                ...
                <td width="632"><table width="614" height="418" border="0">
                  <tr>
                    <td align="center"><p><a href="../../sistema/ADMIN/index.php">Ir a Sistema Mixvial <br />
                    Considera hasta 1ra. Quincena Noviembre 2014</a></p>
                    <p><a href="../../sistemaecovial/ADMIN/index.php">Sistema Ecovial/Rutas hasta el 26-08-2016</a></p></td>
                  </tr>
                </table></td>
              </tr>
            </table>
