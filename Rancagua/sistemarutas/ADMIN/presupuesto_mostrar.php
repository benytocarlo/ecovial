            ...
            <tr>
              <td width="845"><table width="841" border="0">
                ...
                <table width="842" border="1">
                  ...
                  <?	
				   $suma=0;
				    $sql_list ="select * from detalle_presupuesto dp, mezclas me where id_presupuesto=".$n_presupuesto." and dp.id_mezcla=me.id";
						//echo $sql_list;
        ...
        <td height="105"><table width="857" border="0">
          <tr>
            <td><div align="center">_______________________</div>
              <div align="center"><input name="name" style="border:0px" type="text" value="       Carolina Navarro"/></div>
