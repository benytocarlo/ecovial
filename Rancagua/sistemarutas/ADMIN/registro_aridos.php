...
<div class="wrapper">
  ...
  <div class="page-content">	
			<!-- CONTENT -->
			<div id="form_pesaje"><span class="Estilo1">Guia de Aridos</span>
			  <form action="guia_aridos.php" method="post" name="form" id="form"  target="_blank"><table width="566" height="438" align="center"><tr><td id="mezcla_name"><table width="566" height="438">
			    <tr>
			      <td height="81"><strong>Patente</strong> <br />
			      ...
			      <td><strong>Descripción</strong>
			        <div id="servicio">
			          <select name="descripcion" id="descripcion">
			            <option value="">Elija una Opci&oacute;n</option>
			            <? $sql ="SELECT distinct nombre FROM mezclas where nombre!=' ' and tipo='Arido' order by nombre asc";
       // echo $sql;
                                $result = mysql_query($sql); 
                                while($row = mysql_fetch_row($result))
                                {?>
			    ...
			    <tr>
			      ...
			      <td><strong>Cantidad</strong><br />
			        <input name="cantidad" type="text" id="cantidad" /></td>
		        </tr>
			    <tr>
			    ...
			    <tr>
			      ...
			      <td id="mezcla_name2"><input type="button" onclick="valida()" class="formbutton" id="guia" value="Generar Guia" /></td>
		        </tr>
			    </table></td>
            </tr>
          </table>	
