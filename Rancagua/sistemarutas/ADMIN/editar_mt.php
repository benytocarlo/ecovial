...
<div class="sidebar column-left">
  <ul>
    <li>
      <h4>Acciones</h4>
      <ul>
<li><a href="editar_mt.php" > Editar Materias Primas</a></li>
</ul>
    </li>
  </ul>
  <ul>
...
<div class="page-content">	
			<!-- CONTENT -->
			<div id="form_pesaje"><span class="Estilo1">Editar Ingreso de Materias Primas</span>
			  <fieldset>
				<legend></legend>
              </fieldset>
		<form action="editar_materias_primas_confirmacion.php" method="post" name="form" id="form" >
        <center>
<table width="657" height="87" align="center">
<tr>
                        <td width="208" height="81"><strong>Numero de Ingreso de Materias Primas</strong></td>
            <td width="219"><label>
             <select name="n_guia" id="n_guia" >
                    <option value="">Elija una Opci&oacute;n</option>
                    <?$sql ="SELECT * FROM ingreso_materias where nula!='si' order by guia DESC ";
