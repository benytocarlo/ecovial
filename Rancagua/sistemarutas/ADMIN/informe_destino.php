...
<div class="content">
		...
		<div class="page-content">	
			<p>
			  <!-- CONTENT -->
		      <span class="Estilo1">Informe Destino por Cliente</span></p>
            <table width="696" border="0">
              <tr>
                <td width="21" height="258"><p class="clear">&nbsp;</p>
                </td>
                <td width="665"><form id="form1" method="post" action="informes/inf_destino.php" target="_blank">
                  <table width="611" height="137" border="0">
                    <tr>
                      <td width="136" height="43"><strong>Cliente</strong></td>
                      <td width="465"><select name="cliente2" id="cliente2">
