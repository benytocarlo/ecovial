...
<div class="wrapper">
  ...
  <div class="page-content">	
			<!-- CONTENT -->
			<div id="form_pesaje"><span class="Estilo1">Guia para Combustible</span>
			  <fieldset>
				<legend></legend>
              </fieldset>
		<form action="guia4.php" method="post" name="form" id="form" target="_blank" >
        <center>
<table width="566" height="566" align="center">
<tr>
              <td width="297" height="81">N&deg; Pesaje</strong><br />
			...
			<?php
              ...
              <td><strong>N° de Guía</strong>
                <input name="n_guia" type="text" id="n_guia" value="<? echo $n_guia; ?>" readonly="readonly"/><br />
              ...
              <option value="">Elija una Opci&oacute;n</option>
                <? $sql ="SELECT * FROM ingreso_orden order by orden ASC";
                      ...
                      <tr>
                        <td ><strong>Transportista</strong>
       ...
       <span><strong>Producto Agregado a la Orden de Compra - SOLO PUEDE AGREGAR 1 PRODUCTO</strong></span>
       </p>
       <fieldset>
       <legend></legend>
