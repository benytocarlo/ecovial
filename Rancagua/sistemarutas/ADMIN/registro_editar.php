...
<tr>
            ...
            <td width="356"><span class="Estilo3"><br />
				  ...
				  <select name="orden_compra" id="orden_compra" /><br />
                ...
                <? $sql ="SELECT * FROM ingreso_orden order by orden ASC";
                    ...
                    <?
                        ...
                        <? } }?>  
							    ...
							    <strong> Partida Control</strong><br />
			      <input name="partidacontrol" type="text" id="partidacontrol" value="<? echo $partidacontrol; ?>" /> </td>
	  </tr>
                      <tr>
