...
//echo $tipoguia;
if($tipoguia=='emulsion' || $tipoguia=='traslado'  || $tipoguia=='servicio' || $tipoguia=='otro' || $tipoguia=='Arido')
	{ ?>
...
<form name="guia" id="guia">
 ...
 <td width="4%" valign="bottom" align="right"> <p>&nbsp;</p>
 ...
 <td width="7%">&nbsp;</td>
  ...
  <table width="981" border="0" cellpadding="0" cellspacing="0" frame="void" rules="groups" >
   ...
   if($tipoguia=='emulsion')
    ...
    <tr > 
      <td height="21">&nbsp;</td>
      <td width="2%" height="21"><p>&nbsp;</p>
        <p>&nbsp;</p></td>
      <td colspan="4" ><p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <? echo number_format($totaltruncado, 0, '', '.'); ?></td>
      <td height="21">&nbsp;</td>
      <td height="21">&nbsp;</td>
    </tr>
    <tr> 
...
<form name="guia" id="guia">
  ...
  <table width="981" border="0" cellpadding="0" cellspacing="0" frame="void" rules="groups" >
    ...
    <tr> 
      <td height="23" colspan="8" align="center"><table width="113" border="0">
        <tr>
          <td width="26">&nbsp;</td>
          <td width="77">&nbsp;</td>
          </tr>
      </table>
        <strong>GUIA SOLO TRASLADO NO CONSTITUYE VENTA</strong></td>
      </tr>
    <tr>
