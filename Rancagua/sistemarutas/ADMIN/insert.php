...
$oculto=$_POST["oculto"];
	...
	if($oculto=="ingreso_materias")
	{
		...
		$sql="insert into ingreso_materias(orden_compra,guia,proveedor,transportista,materia,fecha_guia,cantidad_total,precio_unitario,patente,peso_bruto,tara,n_pesaje,cantidada_calculada, obra, chofer) values ('$orden','$guia','$proveedor','$transportista','$materia','$fecha','$cantidad','$precio','$patente','$peso','$tara','$n_pesaje','$cant_calculada','$obra','$chofer')";
		$result = mysql_query($sql);
