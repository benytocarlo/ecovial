...
<div class="content">
		...
		<span class="Estilo1">Informe de Producto por Obra</span>
        <table width="696" border="0">
              <tr>
                <td width="21" height="258"><p class="clear">&nbsp;</p>
                </td>
                <td width="665"><form id="form" name="form"  method="post" action="informes/inf_detalle_x_obra_x_producto.php" target="_blank">
                  <table width="608" border="0" cellspacing="0" cellpadding="0">
<tr>
                     <td width="608" height="43"><div id="select_obra">
 <strong> Obra</strong><br /><select name="obra" id="obra">
