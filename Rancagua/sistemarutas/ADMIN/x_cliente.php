...
<div class="content">
		...
		<div class="page-content">	
			<p>
			  <!-- CONTENT -->
		      <span class="Estilo1">Informe de Guias de Servicio de Planta por Cliente</span></p>
            <table width="696" border="0">
              <tr>
                <td width="21" height="258"><p class="clear">&nbsp;</p>
                </td>
                <td width="665"><form id="form1" method="post" action="x_cliente_v2.php" target="_blank">
                  <table width="611" height="182" border="0">
                    ...
                    <tr>
                      <td height="43"><strong>Cliente</strong></td>
