...
<?		 
		 $sql2="select * from ingreso_materias ing_mat, materias mat where ing_mat.fecha_guia  BETWEEN '".$fecha_inicio."' AND '".$fecha_final."' and ing_mat.proveedor=".$proveedor." and ing_mat.materia=mat.id ";
		  $sumacantidad=0;
		  $sumatotal=0;
