...
var x11 = document.form.peso.value;
var x12 = document.form.tara.value;
var x13 = document.form.n_pesaje.value;
    ...
    //valido el nombre
    if (x1=="" || x2=="" || x3=="" || x4=="" || x5=="" || x6=="" || x7=="" || x9=="" || x10=="" || x11=="" || x12=="" || x13==""){
...
<div class="wrapper">
  ...
  <div class="page-content">	
		...
		<form action="guia_emu_cp.php" method="post" name="form" id="form" target="_blank" >
        <center>
<table width="566" height="557" align="center">
<tr>
              <td width="297" height="81"><input type="button" name="nueva_patente" class="formbutton2" style="display:none" value="Nueva Patente"  onclick="xajax_nueva_patente()" id="nueva_patente"/>
			...
			<?php
				...
				?>
                      ...
                      <tr>
                        ...
                        <a href="registro_cliente.php" >Nuevo Cliente</a></td>
      <td id="peso_brutoid"><strong>Peso Bruto</strong> <br />
        <input name="peso" type="text" id="peso" size="10"  readonly="readonly"/></td>
                      ...
                      <tr>
                        ...
                        <td><strong>Tara</strong> <br />
                          <input name="tara" type="text" id="tara" size="10" readonly="readonly"/></td>
                      </tr>
                      <tr>
                        <td height="98"><strong>Valor Unitario Producto<br />
                            <input name="valor_mezcla" type="text" id="valor_mezcla" />
                            <input type="button" name="nuevo_obra2" class="formbutton2" value="Agregar Producto"  onclick="xajax_lista_guia(xajax.getFormValues('form'))" id="nuevo_obra2"/>
                        </strong></td>
                        <td id="mezcla_name3"><input type="button" onclick="valida()" class="formbutton" id="guia" value="Generar Guia" /></td>
                      </tr>
          </table>	
       <span> <strong>Producto Agregado a la Orden de Compra - SOLO PUEDE AGREGAR 1 PRODUCTO</strong></span></p>
        <fieldset>
        <legend></legend>
