		...
		<form id="form" action="actualizar.php?id=<?echo $id; ?>&oculto=camion" method="get">
				    <table>
                      <tr>
                        ...
                        <th width="167">Tipo Vehiculo</th>
                        <th width="137">Patente</th>
                        <th width="223">Tara</th>
                        <th width="112"><span class="Estilo3">Editar - Eliminar </span></th>
                      </tr>
					  <?	  $sql ="select cam.id as id, tran.nombre as transporte, cam.tipo_vehiculo as tipo_vehiculo, cam.patente as patente,cam.tara as tara from camiones cam, transportista tran where cam.empresa=tran.id order by tran.nombre asc";
