...
<div class="page-content">	
			<!-- CONTENT -->
			<span class="Estilo1">Editar de Proveedor</span>
            <fieldset>
				<legend></legend>
                </fieldset>
		<form action="actualizar.php?id=<?echo $id; ?>&oculto=proveedor" method="post" id="form">
<table width="558" height="129">
                      ...
                      <tr>
                        <td><input type="hidden" name="oculto" id="oculto" value="proveedor"/></td>
