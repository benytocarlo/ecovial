...
<div class="page-content">	
			<!-- CONTENT -->
			<div id="form_pesaje"><span class="Estilo1">Eliminar Orde de Compra</span>
			  <fieldset>
				<legend></legend>
              </fieldset>
		<form action="anulacion_oc.php" method="post" name="form" id="form" target="_blank" >
        <center>
...
<tr>
            ...
            <td width="214"><input type="button" class="formbutton" value="Anular" onclick="if(confirm('¿Seguro que desea Anular esta Guia?'))this.form.submit();"/></td>
            </tr>
                    </table>	
        <p>&nbsp;</p>
        <p>&nbsp;</p>
