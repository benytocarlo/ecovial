	...
	<div class="content">
	  ...
	  <ul>	
		...
		<div class="page-content">	
			<!-- CONTENT -->
			<span class="Estilo1">Listado de Choferes</span>
            <fieldset>
				<legend></legend>
		<form id="form" action="actualizar.php?id=<?echo $id; ?>&oculto=camion" method="get">
				    <table>
                      <tr>
                        <th width="65">ID</th>
                        <th width="285">Nombre</th>
                        <th width="199">Rut</th>
                        <th width="129"><span class="Estilo3">Editar - Eliminar </span></th>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td><table width="94" border="0" align="center">
                          <tr>
                            <td width="46" ><a href="editar_chofer.php?id=<? echo $row[0]; ?>"><img src="images/001_45.png" alt="" width="24" height="24" border="0" /></a></td>
                            <td width="64"><a href="eliminar.php?id=<? echo $row[0]; ?>&oculto=chofer"><img src="images/001_05.png" alt="" width="24" height="24" border="0" /></a></td>
                          </tr>
                        </table></td>
                      </tr>
                      <? } ?>
