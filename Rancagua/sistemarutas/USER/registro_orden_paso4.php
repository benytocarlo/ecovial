...
if($descuento>0){
$sql="update orden_compra set sub_neto='$total_descuento' ,descuento='$descuento' ,iva='$iva' , total='$total_bruto' where id=$num_orden";
}else{
$sql="update orden_compra set sub_neto='$total_neto' ,iva='$iva' , total='$total_bruto' where id=$num_orden";
}
