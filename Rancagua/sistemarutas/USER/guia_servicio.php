...
include("conexion.php");
	...
	$precio=$_POST["precio"];
	$sql="insert into pesaje (patente,fecha_hora,transportista,chofer,obra,n_orden,cliente,tipo_guia) values 
							('$patente','$fecha','$transportista','$chofer','$obra','$odcompra','$cliente','servicio')";
	
	$result = mysql_query($sql);
	$sql_inser="insert into detalle_pesaje (guia,producto,litros,valor_unitario) values ('$guia','$descripcion','$cantidad','$precio')";
  ...
  <table width="1024" border="0" cellpadding="0" cellspacing="0" frame="void" rules="groups" >
    <tr> 
      <td width="13%" height="27"><table width="113" border="0" > 
          <tr>
            <td width="77"><? echo $cantidad; ?></td>
          </tr>
        </table>        </td>
      <td colspan="5"><? echo $descripcion; ?></td>
      <td width="14%" align="right"><? echo $precio; ?></td>
