...
<div class="page-content">	
			<!-- CONTENT -->
			<span class="Estilo1">Editar de Materia Prima</span>
            <fieldset>
				<legend></legend>
                </fieldset>
		<form id="form" method="post" action="actualizar.php?id=<?echo $id; ?>&oculto=materia">
<table width="558" height="129">
                      <tr>
                        <td width="194"><strong>Nombre de Materia Prima</strong></td>
